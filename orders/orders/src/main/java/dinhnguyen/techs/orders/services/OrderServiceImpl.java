...
public class OrderServiceImpl implements OrderService {
	...
	public Order save(Order object) {
		...
		try {
			...
			if (order.getId() != null) {
				...
				this.kafkaLogsSender.send("orders", json);
			}
	...
	public Order findById(Long id) {
		...
		if (order.isPresent()) {
			...
			String json = this.kafkaLogsSender.convert("order-service", "OrderServiceImpl", id.toString(),
	...
	public Order update(Order object) {
		...
		if (order.isPresent()) {
			...
			String json = this.kafkaLogsSender.convert("order-service", "OrderServiceImpl", this.gson.toJson(object),
					"Record_Not_Found_Exception");
			kafkaLogsSender.send("logs", json);
			throw new RecordNotFoundExceptions("Record_Not_Found_Exception");
		}
